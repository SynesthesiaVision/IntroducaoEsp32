...
attachInterrupt(button, contar, FALLING); /*função que define que o pino 22, do botão,  vai gerar uma interrupção quando for solto após pressionado(borda de descida) e assim executar a função changeLed()*/
}
